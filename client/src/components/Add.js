    ...
    <div className="flex flex-col h-screen bg-gradient-to-b from-green-800 to-blue-600 p-4 text-black">
      <div className='form'>
       <h1 className='flex justify-center align-center'>Add new Book</h1>
        ...
        <h2> {uploadStatus} </h2>
        <input type='file' placeholder='cover' accept='image/*' multiple={false} onChange={imageHandler} name='cover' className='form flex p-4 justify-center align-center mx-auto my-10'/>{image && <img src={image} alt="img"/>}
